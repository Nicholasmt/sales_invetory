        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header modal-bg">
                    ...
                    <h3 class="modal-title ">Delete <span class="text-capitalize">{{$product->product_name}} Product</span> </h3>
                     <h3 class="font-bold"></h3>
                 </div>
                 <form action="{{ route('adminproducts.destroy',['product'=>$product])}}" method="POST">
                    @csrf
                    @method('DELETE')
